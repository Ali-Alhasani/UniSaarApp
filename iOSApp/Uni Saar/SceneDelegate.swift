    ...
    extension SceneDelegate: NSToolbarDelegate {
        func toolbar(_ toolbar: NSToolbar, itemForItemIdentifier itemIdentifier: NSToolbarItem.Identifier, willBeInsertedIntoToolbar flag: Bool) -> NSToolbarItem? {
            if itemIdentifier == NSToolbarItem.Identifier(rawValue: "tabBarReplacement") {
                let group = NSToolbarItemGroup(itemIdentifier: NSToolbarItem.Identifier(rawValue: "tabBarReplacement"),
                ...
                if UserDefaults.standard.object(forKey: lastOpenTabScreen) != nil {
                    let selectedIndex = UserDefaults.standard.integer(forKey: lastOpenTabScreen)
        ...
        @objc func toolbarGroupSelectionChanged(sender: NSToolbarItemGroup) {
            ...
            UserDefaults.standard.set(sender.selectedIndex, forKey: lastOpenTabScreen)
            UserDefaults.standard.synchronize()
        }

        func toolbarDefaultItemIdentifiers(_ toolbar: NSToolbar) -> [NSToolbarItem.Identifier] {
            [NSToolbarItem.Identifier(rawValue: "tabBarReplacement")]
        }
