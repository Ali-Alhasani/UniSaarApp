...
class FilterMensaViewControllerTests: XCTestCase {
    ...
    override func setUp() async throws {
        ...
        viewControllerUnderTest = storyboard.instantiateViewController(withIdentifier: "FilterMensaViewController") as? FilterMensaViewController
    ...
    func testTableCellHasCorrectLabelText() {
        ...
        let cell = viewControllerUnderTest.tableView(
            viewControllerUnderTest.filterTableView,
            cellForRowAt: IndexPath(row: 0, section: allergenSection)
        ) as? FilterUISwitchTableViewCell
